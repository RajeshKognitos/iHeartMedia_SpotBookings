...
export default function KpiCard({ label, value, icon, variant = "default" }: KpiCardProps) {
  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4 flex items-start gap-3">
      <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full ${bgIcon} text-foreground`}>
        {icon}
      </div>
...
export function IconPercent() {
  return (
    <svg className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 7.5h9m-9 9h9m-9-12.75L16.5 21m-9-9l9-9" />
    </svg>
  );
}
